...
const PACKAGES = [
  { label: "Tremendo Branding", options: [
    "TR-1 Ajuste — $1,500 MXN",
    "TR-2 Esencia — $3,500 MXN",
    "TR-3 Universo — $6,000 MXN",
  ]},
  { label: "Tremendo Content", options: [
    "TR-1 Inicia — $5,700 MXN/mes",
    "TR-2 Expande — $8,500 MXN/mes",
    "TR-3 Impacto — $12,000 MXN/mes",
  ]},
    ...
    <div className="page-hablemos tab-enter">
      <section className="hablemos-hero">
        <Reveal>
          ...
          <h1 className="display hablemos-h">
            ¿Hacemos algo<br />
            <em className="serif-ital" style={{ color: "var(--orange)" }}>tremendo</em> juntas?
          </h1>
          <p className="hablemos-lede">
            Buscamos emprendedoras, creativas y marcas emergentes que estén
        ...
        <Reveal delay={180} className="hablemos-meta">
          <div>
            ...
            <span className="serif-ital">&lt; 48 hrs</span>
          </div>
          <div>
            <span className="eyebrow">Ubicación</span>
            <span className="serif-ital">Guadalajara, MX</span>
          </div>
          <div>
            <span className="eyebrow">Email directo</span>
            <a className="serif-ital" href="mailto:hola@tremendostudio.mx">hola@tremendostudio.mx</a>
          </div>
        </Reveal>
      </section>
      ...
      <section className="hablemos-form-wrap">
        ...
        >
          ...
          <div className="field">
            <label className="eyebrow"><span>03</span> Cuéntanos tu proyecto <em className="serif-ital">soñado.</em></label>
            <textarea
              required
              rows={4}
              value={form.project}
          ...
          <div className="field">
            <label className="eyebrow"><span>04</span> ¿A qué paquete le echaste el ojo?</label>
          ...
          <div className="field-row">
            <div className="field">
              <label className="eyebrow"><span>05</span> Presupuesto aproximado</label>
            ...
            <div className="field">
              <label className="eyebrow"><span>06</span> ¿Para cuándo?</label>
              <div className="chip-grid tight">
                {WHENS.map((b) => (
                  <button
                    key={b}
          ...
          <div className="field">
            <label className="eyebrow"><span>07</span> ¿Cómo nos encontraste? <span className="opt">(opcional)</span></label>
            <input
              type="text"
              value={form.heard}
              onChange={set("heard")}
        ...
        <aside className="hablemos-side">
          ...
          <div className="side-card side-dark">
            ...
            <p className="serif-ital">
              "No contestamos plantillas. Leemos cada mensaje con calma —
              y te respondemos como a una amiga."
            </p>
