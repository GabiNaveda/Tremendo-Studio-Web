...
const BRANDING_PKG = [
{ tier: "TR-1", name: "Ajuste", price: "$1,500", unit: "MXN", tag: "para empezar",
  blurb: "Lo que ya tienes, pero mejorado.",
  features: ["Refinamiento y limpieza de logo actual", "Vectorización profesional", "Paleta + tipografías definidas", "Entrega en 5 días hábiles"] },
{ tier: "TR-2", name: "Esencia", price: "$3,500", unit: "MXN", tag: "más elegido",
...
{ tier: "TR-3", name: "Universo", price: "$6,000", unit: "MXN", tag: "full immersion",
...
const CONTENT_PKG = [
{ tier: "TR-1", name: "Inicia", price: "$5,700", unit: "MXN / mes", tag: "básico",
  blurb: "El impulso visual que tu feed pide a gritos.",
  features: ["10 artes estáticos", "2 videos editados", "Estrategia mensual básica", "1 shooting cada 2 meses"] },
{ tier: "TR-2", name: "Expande", price: "$8,500", unit: "MXN / mes", tag: "el sweet spot",
  blurb: "Para cuando la marca ya camina y quiere correr.",
  features: ["15 artes estáticos", "4 videos editados", "8 stories interactivos", "Estrategia personalizada", "1 shooting mensual"] },
{ tier: "TR-3", name: "Impacto", price: "$12,000", unit: "MXN / mes", tag: "pro",
  blurb: "Estrategia omnicanal. Marca siempre visible.",
  features: ["20 artes estáticos", "6 videos profesionales", "Stories diarios", "Estrategia omnicanal", "2 shootings mensuales", "Reporte de métricas mensual"] }];
  ...
  return (
    <div
      ...
      <div className="pkg-card-top">
        ...
        <span className="pkg-tag serif-ital">{pkg.tag}</span>
      </div>
      ...
      <>
          ...
          <p className="pkg-blurb serif-ital">{pkg.blurb}</p>
